    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="container mx-auto px-4 py-12 grid gap-8 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              <Link to="/" hash="recursos" className="hover:text-foreground">
                Recursos
              </Link>
            </li>
            <li>
              <Link to="/" hash="assistente" className="hover:text-foreground">
                Assistente de Lucro
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h4 className="text-sm font-semibold mb-3">Conta e legal</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
      ...
      <div className="border-t border-border">
        <div className="container mx-auto px-4 py-5 text-xs text-muted-foreground flex flex-col md:flex-row justify-between gap-2">
          <span>
            © {new Date().getFullYear()} Central do Comerciante. Todos os direitos reservados.
          </span>
