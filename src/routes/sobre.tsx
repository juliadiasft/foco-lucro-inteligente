...
export const Route = createFileRoute("/sobre")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça a missão da Central do Comerciante: ajudar pequenos comerciantes brasileiros a lucrar mais." },
    ],
  }),
  component: Sobre,
});
...
function Sobre() {
  const valores = [
    { i: Target, t: "Foco no lucro", d: "Cada recurso existe para aumentar o lucro do comerciante." },
    { i: Heart, t: "Feito para o pequeno", d: "Para mercados de bairro, mercearias, adegas e lojas de conveniência." },
    { i: Sparkles, t: "Inteligência prática", d: "IA que entrega recomendações simples e acionáveis." },
  ];
  return (
    <SiteLayout>
      <section className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
        ...
        <p className="mt-6 text-lg text-muted-foreground">
          A Central do Comerciante nasceu da constatação de que mercados de bairro, mercearias e adegas
          perdem dinheiro todos os meses sem perceber: comprando pelo fornecedor errado, com estoque
          parado, com margens abaixo do ideal. Nosso papel é mostrar, com clareza, onde está esse
          dinheiro — e como recuperá-lo.
        </p>
        ...
        <div className="mt-12 text-center">
          <Button asChild size="lg" className="bg-gradient-hero text-primary-foreground shadow-elegant">
            <Link to="/cadastro">Comece o teste grátis</Link>
          </Button>
        </div>
      </section>
    </SiteLayout>
